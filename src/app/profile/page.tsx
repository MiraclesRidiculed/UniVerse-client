      ...
      <div className="bg-gray-900 shadow-md rounded-lg p-6">
        ...
        <div className="mt-6 border-t border-gray-200 pt-6">
          ...
          <div className="mt-4 flex flex-col space-y-4">
            ...
            <a
              href={user?.handles.linkedin || 'https://linkedin.com/in/example'}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={user?.handles.instagram || 'https://instagram.com/example'}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={user?.handles.facebook || 'https://facebook.com/example'}
              target="_blank"
              rel="noopener noreferrer"
